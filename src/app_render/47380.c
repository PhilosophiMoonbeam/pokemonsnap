...
void func_8009E3D0(GObj* gobj) {
    ...
    gDPSetColorDither(gMainGfxPos[0]++, G_CD_MAGICSQ);
    gDPSetAlphaDither(gMainGfxPos[0]++, G_AD_PATTERN);
    ...
    gDPSetDepthSource(gMainGfxPos[0]++, G_ZS_PIXEL);
