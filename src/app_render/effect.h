...
#define FX_BANK_ID_MASK 0x7
#define FX_BANK_GROUP_SHIFT 3
#define FX_GET_BANK_INDEX(bankID) ((bankID) & FX_BANK_ID_MASK)
#define FX_GET_BANK_GROUP(bankID) ((bankID) >> FX_BANK_GROUP_SHIFT)

#define PARTICLE_FLAG_ATTACH_DOBJ 0x8000
#define PARTICLE_ATTACH_DOBJ_INDEX_SHIFT 12
#define PARTICLE_ATTACH_DOBJ_INDEX_MASK 0x7000
#define PARTICLE_PACK_ATTACH_DOBJ_INDEX(index) ((index) << PARTICLE_ATTACH_DOBJ_INDEX_SHIFT)
#define PARTICLE_GET_ATTACH_DOBJ_INDEX(flags) (((flags) & PARTICLE_ATTACH_DOBJ_INDEX_MASK) >> PARTICLE_ATTACH_DOBJ_INDEX_SHIFT)
